<template>
  <header class="app-header">
    <div class="header-left">
      <button class="sidebar-toggle" @click="$emit('toggleSidebar')" :aria-label="t('common.toggleSidebar', 'Toggle sidebar')">
    ...
    <div class="header-right">
      ...
      <button class="logout-btn" @click="handleLogout" :aria-label="t('common.logout', 'Logout')">
