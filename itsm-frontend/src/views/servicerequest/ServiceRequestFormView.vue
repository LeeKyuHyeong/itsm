<template>
  <div class="sr-form">
    <div class="page-header">
      <h2>{{ isEdit ? '서비스요청 수정' : '서비스요청 등록' }}</h2>
    </div>

    <form @submit.prevent="handleSubmit" class="form-card">
      <div class="form-group">
        <label class="required">제목</label>
        <input v-model="form.title" type="text" required placeholder="요청 제목을 입력하세요" />
      </div>

      <div class="form-row">
        <div class="form-group">
          <label class="required">요청 유형</label>
      ...
      <div class="form-row">
        <div class="form-group">
          <label class="required">요청일시</label>
      ...
      <div class="form-group">
        <label class="required">요청 내용</label>
        <textarea v-model="form.content" rows="6" required placeholder="요청 상세 내용을 입력하세요"></textarea>
      </div>
