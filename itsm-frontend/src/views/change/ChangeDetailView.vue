...
.status-APPROVED { background: var(--color-btn-success-bg); color: var(--color-btn-success); }
.status-REJECTED { background: var(--color-priority-critical-bg); color: var(--color-priority-critical); }
.approver-date {
