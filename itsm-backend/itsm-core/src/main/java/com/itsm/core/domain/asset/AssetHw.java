...
@Entity
@Table(name = "tb_asset_hw", indexes = {
        @Index(name = "idx_asset_hw_status", columnList = "status"),
        @Index(name = "idx_asset_hw_type_cd", columnList = "asset_type_cd"),
        @Index(name = "idx_asset_hw_company_id", columnList = "company_id")
})
@Getter
