...
@Entity
@Table(name = "tb_asset_sw_history")
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
@EntityListeners(AuditingEntityListener.class)
public class AssetSwHistory {
    ...
    @Column(name = "asset_sw_id", nullable = false)
    ...
    @Builder
    public AssetSwHistory(Long assetSwId, String changedField, String beforeValue,
