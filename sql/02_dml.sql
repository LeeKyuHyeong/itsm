...
(1,  NULL, '대시보드',       '/dashboard',        'mdi-view-dashboard',  1,  'Y', 'ACTIVE', NOW(), 1),
(2,  NULL, '장애관리',       NULL,                'mdi-alert-circle',    2,  'Y', 'ACTIVE', NOW(), 1),
(3,  NULL, '서비스요청',     NULL,                'mdi-file-document',   3,  'Y', 'ACTIVE', NOW(), 1),
(4,  NULL, '변경관리',       NULL,                'mdi-swap-horizontal', 4,  'Y', 'ACTIVE', NOW(), 1),
(5,  NULL, '자산관리',       NULL,                'mdi-server',          5,  'Y', 'ACTIVE', NOW(), 1),
(6,  NULL, '정기점검관리',   NULL,                'mdi-clipboard-check', 6,  'Y', 'ACTIVE', NOW(), 1),
(7,  NULL, '보고관리',       NULL,                'mdi-chart-bar',       7,  'Y', 'ACTIVE', NOW(), 1),
(8,  NULL, '게시판',         NULL,                'mdi-bulletin-board',  8,  'Y', 'ACTIVE', NOW(), 1),
(9,  NULL, '설정관리',       NULL,                'mdi-cog',             9,  'Y', 'ACTIVE', NOW(), 1),
(10, NULL, '계정관리',       NULL,                'mdi-account-group',   10, 'Y', 'ACTIVE', NOW(), 1);
...
-- 우선순위
INSERT INTO tb_common_code (group_id, group_nm, group_cd, description, is_active, created_at, created_by)
VALUES (1, '우선순위', 'PRIORITY', '장애/서비스요청/변경 우선순위', 'Y', NOW(), 1);

INSERT INTO tb_common_code_detail (group_id, code_val, code_nm, sort_order, is_active, created_at, created_by) VALUES
(1, 'CRITICAL', '긴급',  1, 'Y', NOW(), 1),
(1, 'HIGH',     '높음',  2, 'Y', NOW(), 1),
(1, 'MEDIUM',   '보통',  3, 'Y', NOW(), 1),
(1, 'LOW',      '낮음',  4, 'Y', NOW(), 1);

-- 장애유형
INSERT INTO tb_common_code (group_id, group_nm, group_cd, description, is_active, created_at, created_by)
VALUES (2, '장애유형', 'INCIDENT_TYPE', '장애 유형 분류', 'Y', NOW(), 1);

INSERT INTO tb_common_code_detail (group_id, code_val, code_nm, sort_order, is_active, created_at, created_by) VALUES
(2, 'SYSTEM_DOWN',    '시스템 장애',    1, 'Y', NOW(), 1),
(2, 'NETWORK_ISSUE',  '네트워크 장애',  2, 'Y', NOW(), 1),
(2, 'SECURITY',       '보안 사고',      3, 'Y', NOW(), 1),
(2, 'PERFORMANCE',    '성능 저하',      4, 'Y', NOW(), 1),
(2, 'DATA_ISSUE',     '데이터 오류',    5, 'Y', NOW(), 1),
(2, 'OTHER',          '기타',           6, 'Y', NOW(), 1);

-- 서비스요청 유형
INSERT INTO tb_common_code (group_id, group_nm, group_cd, description, is_active, created_at, created_by)
VALUES (3, '서비스요청 유형', 'REQUEST_TYPE', '서비스 요청 유형 분류', 'Y', NOW(), 1);

INSERT INTO tb_common_code_detail (group_id, code_val, code_nm, sort_order, is_active, created_at, created_by) VALUES
(3, 'ACCOUNT',         '계정 요청',      1, 'Y', NOW(), 1),
(3, 'INSTALL',         '설치 요청',      2, 'Y', NOW(), 1),
(3, 'CONFIGURATION',   '설정 변경',      3, 'Y', NOW(), 1),
(3, 'DATA_REQUEST',    '데이터 요청',    4, 'Y', NOW(), 1),
(3, 'INQUIRY',         '문의',           5, 'Y', NOW(), 1),
(3, 'OTHER',           '기타',           6, 'Y', NOW(), 1);

-- 변경유형
INSERT INTO tb_common_code (group_id, group_nm, group_cd, description, is_active, created_at, created_by)
VALUES (4, '변경유형', 'CHANGE_TYPE', '변경 요청 유형 분류', 'Y', NOW(), 1);

INSERT INTO tb_common_code_detail (group_id, code_val, code_nm, sort_order, is_active, created_at, created_by) VALUES
(4, 'EMERGENCY', '긴급 변경', 1, 'Y', NOW(), 1),
(4, 'NORMAL',    '일반 변경', 2, 'Y', NOW(), 1),
(4, 'STANDARD',  '정기 변경', 3, 'Y', NOW(), 1);

-- HW 자산유형
INSERT INTO tb_common_code (group_id, group_nm, group_cd, description, is_active, created_at, created_by)
VALUES (5, 'HW 자산유형', 'ASSET_HW_TYPE', 'HW 자산 유형 분류', 'Y', NOW(), 1);

INSERT INTO tb_common_code_detail (group_id, code_val, code_nm, sort_order, is_active, created_at, created_by) VALUES
(5, 'SERVER',    '서버',         1, 'Y', NOW(), 1),
(5, 'NETWORK',   '네트워크장비', 2, 'Y', NOW(), 1),
(5, 'PC',        'PC/노트북',    3, 'Y', NOW(), 1),
(5, 'STORAGE',   '스토리지',     4, 'Y', NOW(), 1),
(5, 'SECURITY',  '보안장비',     5, 'Y', NOW(), 1),
(5, 'OTHER',     '기타',         6, 'Y', NOW(), 1);

-- SW 자산유형
INSERT INTO tb_common_code (group_id, group_nm, group_cd, description, is_active, created_at, created_by)
VALUES (6, 'SW 자산유형', 'ASSET_SW_TYPE', 'SW 자산 유형 분류', 'Y', NOW(), 1);

INSERT INTO tb_common_code_detail (group_id, code_val, code_nm, sort_order, is_active, created_at, created_by) VALUES
(6, 'OS',        '운영체제',      1, 'Y', NOW(), 1),
(6, 'WAS',       'WAS',           2, 'Y', NOW(), 1),
(6, 'DB',        'DBMS',          3, 'Y', NOW(), 1),
(6, 'SECURITY',  '보안 소프트웨어', 4, 'Y', NOW(), 1),
(6, 'OFFICE',    '오피스/업무용',  5, 'Y', NOW(), 1),
(6, 'OTHER',     '기타',           6, 'Y', NOW(), 1);

-- 점검유형
INSERT INTO tb_common_code (group_id, group_nm, group_cd, description, is_active, created_at, created_by)
VALUES (7, '점검유형', 'INSPECTION_TYPE', '정기점검 유형 분류', 'Y', NOW(), 1);

INSERT INTO tb_common_code_detail (group_id, code_val, code_nm, sort_order, is_active, created_at, created_by) VALUES
(7, 'MONTHLY',   '월간 점검',  1, 'Y', NOW(), 1),
(7, 'QUARTERLY', '분기 점검',  2, 'Y', NOW(), 1),
(7, 'ANNUAL',    '연간 점검',  3, 'Y', NOW(), 1),
(7, 'SPECIAL',   '특별 점검',  4, 'Y', NOW(), 1);

-- 보고서 양식 유형
INSERT INTO tb_common_code (group_id, group_nm, group_cd, description, is_active, created_at, created_by)
VALUES (8, '보고서 양식유형', 'REPORT_FORM_TYPE', '보고서 양식 유형 분류', 'Y', NOW(), 1);

INSERT INTO tb_common_code_detail (group_id, code_val, code_nm, sort_order, is_active, created_at, created_by) VALUES
(8, 'INCIDENT',         '장애 보고서',         1, 'Y', NOW(), 1),
(8, 'SERVICE_REQUEST',  '서비스요청 보고서',   2, 'Y', NOW(), 1),
(8, 'CHANGE',           '변경 보고서',         3, 'Y', NOW(), 1),
(8, 'INSPECTION',       '점검 보고서',         4, 'Y', NOW(), 1);

-- 게시판 유형
INSERT INTO tb_common_code (group_id, group_nm, group_cd, description, is_active, created_at, created_by)
VALUES (9, '게시판유형', 'BOARD_TYPE', '게시판 유형 분류', 'Y', NOW(), 1);

INSERT INTO tb_common_code_detail (group_id, code_val, code_nm, sort_order, is_active, created_at, created_by) VALUES
(9, 'NOTICE',   '공지형',  1, 'Y', NOW(), 1),
(9, 'FREE',     '자유형',  2, 'Y', NOW(), 1),
(9, 'ARCHIVE',  '자료형',  3, 'Y', NOW(), 1);

-- 알림유형
INSERT INTO tb_common_code (group_id, group_nm, group_cd, description, is_active, created_at, created_by)
VALUES (10, '알림유형', 'NOTIFICATION_TYPE', '알림 유형 분류', 'Y', NOW(), 1);

INSERT INTO tb_common_code_detail (group_id, code_val, code_nm, sort_order, is_active, created_at, created_by) VALUES
(10, 'INCIDENT',         '장애 알림',         1, 'Y', NOW(), 1),
(10, 'SERVICE_REQUEST',  '서비스요청 알림',   2, 'Y', NOW(), 1),
(10, 'CHANGE',           '변경 알림',         3, 'Y', NOW(), 1),
(10, 'INSPECTION',       '점검 알림',         4, 'Y', NOW(), 1),
(10, 'SLA_WARNING',      'SLA 경고 알림',     5, 'Y', NOW(), 1),
(10, 'SYSTEM',           '시스템 알림',       6, 'Y', NOW(), 1);
